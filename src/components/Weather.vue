...
export default{
    ...
    data(){
        return{
            ...
            isLoading: false,
            apikey: 'b79c028832c76ba3ff0e3d4ea7802498' //openweathermap에서 발급한 API key
        }
    },
    computed: {
            //날씨에 어울리는 색상으로 background gradient 적용
    ...
    methods:{
        ...
        getWeather: function(){
            ...
            this.$http.get(reqURL, {headers: {'x-requested-with': 'XMLHttpRequest'}}).then(
                function (response) {
